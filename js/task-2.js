...
const createGalleryImgs = image => {
  const galleryItemEl = document.createElement('li');
  galleryItemEl.classList.add('gallery-item', 'js-gallery-item');

  const galleryImgEl = document.createElement('img');
  galleryImgEl.classList.add('js-gallery-img', 'gallery-img');
...
const galleryImgsArr = images.map(image => createGalleryImgs(image));

const galleryUl = document.querySelector("ul.gallery");

galleryUl.append(...galleryImgsArr);